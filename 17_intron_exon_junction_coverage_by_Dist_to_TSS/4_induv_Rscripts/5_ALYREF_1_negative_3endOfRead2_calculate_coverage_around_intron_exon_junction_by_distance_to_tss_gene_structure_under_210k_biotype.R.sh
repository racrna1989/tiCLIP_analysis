...
SCRIPT="calculate_coverage_around_intron_exon_junction_by_distance_to_tss_gene_structure_under_210k_biotype.R"
...
for inCount in 8_rna_binding_maps/4_intron_exon_junction_coverage_by_exon_context/*200228/ALYREF_1_negative_3endOfRead2*3end.100nt*counts; do 
