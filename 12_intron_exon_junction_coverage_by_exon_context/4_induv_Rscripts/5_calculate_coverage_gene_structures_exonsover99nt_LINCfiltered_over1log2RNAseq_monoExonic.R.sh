...
SCRIPT="master_scripts/12_intron_exon_junction_coverage_by_exon_context/calculate_coverage_gene_structures_exonsover99nt_LINCfiltered_over1log2RNAseq_monoExonic.R"
