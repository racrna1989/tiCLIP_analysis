...
SCRIPT="master_scripts/12_intron_exon_junction_coverage_by_exon_context/calculate_coverage_gene_structures_exonsover99nt_LINCfiltered_over1log2RNAseq_multiExonic.R"
...
for inCount in 8_rna_binding_maps/4_intron_exon_junction_coverage_by_exon_context/read2-bg-rRNAscaled-200228/*3end.100nt*counts; do 
