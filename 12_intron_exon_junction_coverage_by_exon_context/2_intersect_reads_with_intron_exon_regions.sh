...
inBedGraphRead2=$INDIR"read2/CHANGEME"
mkdir -p $outDirRead2 
...
inBedGraph5primepos=$INDIR"5primepos/CHANGEME"
...
inBedGraph3endOfRead2=$INDIR"3endOfRead2/CHANGEME"
...
inBedGraphRead1=$INDIR"read1/CHANGEME"
mkdir -p $outDirRead1
