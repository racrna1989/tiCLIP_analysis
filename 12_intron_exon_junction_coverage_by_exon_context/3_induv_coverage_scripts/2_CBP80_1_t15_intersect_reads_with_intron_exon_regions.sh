...
inBedGraphRead2=$INDIR"read2/CBP80_1_t15*rRNAScaled"
mkdir -p $outDirRead2 
...
inBedGraph5primepos=$INDIR"5primepos/CBP80_1_t15*rRNAScaled"
...
inBedGraph3endOfRead2=$INDIR"3endOfRead2/CBP80_1_t15*rRNAScaled"
...
inBedGraphRead1=$INDIR"read1/CBP80_1_t15*rRNAScaled"
mkdir -p $outDirRead1
