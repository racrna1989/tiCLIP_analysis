...
inBedGraphRead2=$INDIR"read2/PHAX_1_t00*rRNAScaled"
mkdir -p $outDirRead2 
...
inBedGraph5primepos=$INDIR"5primepos/PHAX_1_t00*rRNAScaled"
...
inBedGraph3endOfRead2=$INDIR"3endOfRead2/PHAX_1_t00*rRNAScaled"
...
inBedGraphRead1=$INDIR"read1/PHAX_1_t00*rRNAScaled"
mkdir -p $outDirRead1
