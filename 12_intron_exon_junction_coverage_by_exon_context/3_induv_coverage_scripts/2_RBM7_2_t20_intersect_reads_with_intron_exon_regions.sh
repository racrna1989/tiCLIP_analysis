...
inBedGraphRead2=$INDIR"read2/RBM7_2_t20*rRNAScaled"
mkdir -p $outDirRead2 
...
inBedGraph5primepos=$INDIR"5primepos/RBM7_2_t20*rRNAScaled"
...
inBedGraph3endOfRead2=$INDIR"3endOfRead2/RBM7_2_t20*rRNAScaled"
...
inBedGraphRead1=$INDIR"read1/RBM7_2_t20*rRNAScaled"
mkdir -p $outDirRead1
