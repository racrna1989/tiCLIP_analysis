...
awk '{OFS="\t"}{if ($6 =="+"){print $1,$3,$3+500,$4":::500nt_downstream",$5,$6} else if ($6 =="-"){print $1, $2-500,$2,$4":::500nt_downstream",$5,$6}}' snRNA.GRCh38101_and_Soren_anno.bed > extentions.tmp
awk '{OFS="\t"}{$4=$4":::genebody"; print $0}' snRNA.GRCh38101_and_Soren_anno.bed | cat - extentions.tmp | sort -k1,1 -k2,2n | grep -v "KI27" | grep -v "GL00" > snRNA.GRCh38101_and_Soren_anno_500ntextention.bed
...
ln -s ~/faststorage/GRCh38/snRNA/snRNA.GRCh38101_and_Soren_anno_500ntextention.bed .
...
awk '{OFS="\t"}{if ($6 =="+"){print $1,$2-100,$3+500,$4":::100ntup500ntdown",$5,$6} else if ($6 =="-"){print $1,$2-500,$3+100,$4":::100ntup500ntdown",$5,$6}}' snRNA.GRCh38101_and_Soren_anno.bed > snRNA.GRCh38101_and_Soren_anno.interval100ntup500down.bed

cd /home/racrna/4_xiCLIP/annotationFiles/

ln -s ~/faststorage/GRCh38/snRNA/snRNA.GRCh38101_and_Soren_anno_interval100ntup500down.bed . 
