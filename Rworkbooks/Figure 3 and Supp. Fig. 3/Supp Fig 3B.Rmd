...
COUNTS="../../data/xiCLIP_read2_mono_multi_exonic.calculate_coverage_gene_structures_exonsover99nt_LINCfiltered_over1logNAseq_multiExonic.tab"
...
```{r}
#beow code was ran on cluster to process large count files produced when analysing whole reads
##!/usr/bin/env Rscript
#
...
DF %>% 
  ...
  theme_bw() + 
  labs(subtitle = "whole read coverage") 
