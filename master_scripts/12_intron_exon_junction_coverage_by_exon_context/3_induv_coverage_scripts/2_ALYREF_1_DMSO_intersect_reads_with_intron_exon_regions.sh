...
inBedGraphRead2=$INDIR"read2/ALYREF_1_DMSO*rRNAScaled"
mkdir -p $outDirRead2 
...
inBedGraph5primepos=$INDIR"5primepos/ALYREF_1_DMSO*rRNAScaled"
...
inBedGraph3endOfRead2=$INDIR"3endOfRead2/ALYREF_1_DMSO*rRNAScaled"
...
inBedGraphRead1=$INDIR"read1/ALYREF_1_DMSO*rRNAScaled"
mkdir -p $outDirRead1
