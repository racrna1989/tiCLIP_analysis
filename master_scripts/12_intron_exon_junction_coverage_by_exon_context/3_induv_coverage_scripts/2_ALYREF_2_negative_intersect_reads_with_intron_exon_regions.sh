...
OUTDIR="8_rna_binding_maps/4_intron_exon_junction_coverage_by_exon_context/"

mkdir -p $OUTDIR

INDIR="5_bedGraphs_and_derivatives/"

inAnnotation5end="annotationFiles/hg38_HeLa_trimmed_loci_major_primary_isoform_annotated.exonNumber.sizeRange.TotalExonNumber.DistFromTSS.relDistToTSS.5end.100ntupdown.binN201.bed"
inAnnotation3end="annotationFiles/hg38_HeLa_trimmed_loci_major_primary_isoform_annotated.exonNumber.sizeRange.TotalExonNumber.DistFromTSS.relDistToTSS.3end.100ntupdown.binN201.bed"

#Read2
outDirRead2=$OUTDIR"read2-bg-rRNAscaled-200228/"
inBedGraphRead2=$INDIR"read2/ALYREF_2_negative*rRNAScaled"
mkdir -p $outDirRead2 
...
inBedGraph5primepos=$INDIR"5primepos/ALYREF_2_negative*rRNAScaled"
...
inBedGraph3endOfRead2=$INDIR"3endOfRead2/ALYREF_2_negative*rRNAScaled"
...
inBedGraphRead1=$INDIR"read1/ALYREF_2_negative*rRNAScaled"
mkdir -p $outDirRead1
