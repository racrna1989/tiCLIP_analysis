...
INDIR="8_rna_binding_maps/7_relative_distance_to_TSS_whole_transcript"
ANNOTATION_BED_FILEPATH="annotationFiles/hg38_HeLa_trimmed_loci_major_primary_transcript.TotalExons.bed"
SCRIPT="master_scripts/15_metaprofiles_for_multi_mono_exonic_genes_whole_transcript/4_normalise_and_scale_relative_dist_from_TSS_whole_transcript_by_biotype.R"
...
for DATA_FRAME_FILEPATH in $INDIR/*biotype*tab; do 
