...
SCRIPT="master_scripts/11_snoRNA_and_host_introns_coverage/calculate_snoRNA_intron_coverage_no_gene_norm.R"
...
OUT_NAME=$(echo $inCount | sed 's/\./\t/g' | awk '{OFS="\t"}{print $1"_"$2"_"$3"."$4"_no_gene_norm.tab"}' )
