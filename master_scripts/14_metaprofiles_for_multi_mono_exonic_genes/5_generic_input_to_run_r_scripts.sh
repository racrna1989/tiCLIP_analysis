...
INDIR="8_rna_binding_maps/6_relative_distance_to_TSS_exonic_signal_only"
ANNOTATION_BED_FILEPATH="annotationFiles/hg38_HeLa_trimmed_loci_major_primary_isoform_annotated.exonNumber.sizeRange.TotalExonNumber.DistFromTSS.relDistToTSS.bed"
SCRIPT="master_scripts/14_metaprofiles_for_multi_mono_exonic_genes/4_normalise_and_process_relative_distance_from_TSS_exons.R"
