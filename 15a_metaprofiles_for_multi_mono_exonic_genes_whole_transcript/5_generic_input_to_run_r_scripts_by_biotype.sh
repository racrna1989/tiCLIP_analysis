...
SCRIPT="master_scripts/15a_metaprofiles_for_multi_mono_exonic_genes_whole_transcript/4_normalise_and_scale_relative_dist_from_TSS_whole_transcript_by_biotype.R"
